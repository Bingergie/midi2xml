 ...
 * 
 * <p>Java class for metronome-note complex type</p>.
 * 
...
public class MetronomeNote {
     ...
     * This is why there is not a <CODE>set</CODE> method for the metronomeDot property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the metronomeBeam property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
