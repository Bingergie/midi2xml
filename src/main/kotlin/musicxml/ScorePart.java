 ...
 * 
 * <p>Java class for score-part complex type</p>.
 * 
...
public class ScorePart {
     ...
     * This is why there is not a <CODE>set</CODE> method for the partLink property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the scoreInstrument property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the player property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the midiDeviceAndMidiInstrument property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
