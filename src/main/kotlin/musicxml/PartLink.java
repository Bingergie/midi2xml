 ...
 * 
 * <p>Java class for part-link complex type</p>.
 * 
...
public class PartLink {
     ...
     * This is why there is not a <CODE>set</CODE> method for the instrumentLink property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the groupLink property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
