 ...
 * 
 * <p>Java class for key complex type</p>.
 * 
...
public class Key {
     ...
     * This is why there is not a <CODE>set</CODE> method for the nonTraditionalKey property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the keyOctave property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
